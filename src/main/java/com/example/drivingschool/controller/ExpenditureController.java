...
//    }
    ...
    public ResponseEntity<ApiResponse<List<ExpenditureResponse>>> getByuser(@PathVariable String username) {
        List<ExpenditureResponse> list = expenditureService.getByuser(username);
        return ResponseEntity.ok(new ApiResponse<>(true, "Expenses for " + username, list));
    }
}